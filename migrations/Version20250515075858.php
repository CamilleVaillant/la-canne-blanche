 ...
 */
final class Version20250515075858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE tatoo (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, tatoo VARCHAR(255) NOT NULL, date VARCHAR(255) NOT NULL, INDEX IDX_257AEA59A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
